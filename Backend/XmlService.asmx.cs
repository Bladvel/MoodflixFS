    ...
    public class XmlService : System.Web.Services.WebService
    {
        ...
        public string ExportarProductosComoXml()
        {
            try
            {
                ...
                // 2. Limpiar las referencias de emociones para evitar problemas de serialización
                foreach (var producto in productos)
                {
                    // Establecer Emociones como null para evitar problemas de serialización
                    // El XmlSerializer no puede serializar ICollection
                    producto.Emociones = null;
                }

                // 3. Usar XmlSerializer para convertir la lista de objetos a XML
